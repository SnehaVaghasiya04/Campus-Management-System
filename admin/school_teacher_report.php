...
// Fetch total records
$resultCount = mysqli_query($conn, "SELECT COUNT(*) AS total FROM staff");
$totalRows = mysqli_fetch_assoc($resultCount)['total'];
$totalPages = ceil($totalRows / $limit);

// Search functionality
$search = isset($_GET['search']) ? $_GET['search'] : '';
$whereClause = $search ? "WHERE name LIKE '%$search%' OR role LIKE '%$search%'" : "";

// Fetch limited records
$query = "SELECT * FROM staff $whereClause LIMIT $start, $limit";
...
<body>
    ...
    <div class="container1">
        <fieldset>
   <legend>     <h1>School Teacher Report</h1></legend>
