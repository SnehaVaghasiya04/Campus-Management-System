...
$result = mysqli_query($conn, "
    ...
    WHERE hs.school_college LIKE '%College%'
");
...
<head>
    <meta charset="UTF-8">
    <title>Allocated College Students List</title>
...
<div class="container mt-4">
    <div class="container1">
        <fieldset>
            <legend><h1>Allocated College Students List</h1></legend>
            ...
            <table>
                ...
                if (mysqli_num_rows($allocated) > 0) {
                    ...
                    echo "<tr><td colspan='5'>No allocated college students found.</td></tr>";
                }
                ?>
            </table>
