...
$checkAttendance = mysqli_query($conn, "SELECT * FROM hostel_attendance WHERE date = '$today' AND admission_id IN (SELECT admission_id FROM hostel_student WHERE school_college='College') LIMIT 1");
...
if (isset($_POST['submit']) && !$attendanceMarked) {
    ...
    echo "<script>alert('College Attendance marked successfully!'); window.location.href='college_attendance.php';</script>";
}
?>
...
<div class="container mt-4">
        <div class="container1">
            <fieldset>
                <legend><h1>Mark College Students Attendance</h1></legend>
    ...
    <?php else: ?>
        ...
        <form method="post">
            ...
            <table>
                ...
                <?php
                $students = mysqli_query($conn, "SELECT admission_id, name FROM hostel_student WHERE school_college='College'");
